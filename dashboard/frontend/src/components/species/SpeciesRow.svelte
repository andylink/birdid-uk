...
>
	...
	<div class="flex flex-col gap-0.5 flex-1 min-w-0">
		<div class="flex items-center gap-2">
			<span class="font-semibold text-slate-100 text-sm truncate">{species.species}</span>
	...
	<!-- Detections -->
	<div class="w-24 text-right tabular-nums text-sm font-bold text-emerald-400">
		{species.detections.toLocaleString()}
	</div>

	<!-- Peak confidence -->
	<div class="w-16 text-right tabular-nums text-xs text-slate-400 hidden sm:block">
